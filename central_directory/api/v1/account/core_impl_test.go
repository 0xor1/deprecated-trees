...
//	miscFuncs.On("newCreatedNamedEntity", "ali").Return(nil)
//
//	err := api.Register("ali", "email@email.com", "P@ss-W0rd", "us")
//	assert.IsType(t, &ErrorRef{}, err)
//}
...
//	accountCore := NewCreatedNamedEntity("ali")
//	accountCore.CreatedOn = timeNowReplacement
//	miscFuncs.On("newCreatedNamedEntity", "ali").Return(accountCore)
//	store.On(
//		"createUser",
//		&fullUserInfo{
//			me: me{
...
//
//	myId := NewId()
//	accountCore := NewCreatedNamedEntity("newOrg")
//	accountCore.CreatedOn = timeNowReplacement
//	internalRegionClient.On("IsValidRegion", "us").Return(true)
//	store.On("accountWithCiNameExists", "newOrg").Return(false, nil)
...
//	internalRegionClient.On("IsValidRegion", "us").Return(true)
//	store.On("accountWithCiNameExists", "newOrg").Return(false, nil)
//	miscFuncs.On("newCreatedNamedEntity", "newOrg").Return(accountCore)
//	store.On("createOrgAndMembership", &account{
//		CreatedNamedEntity: *accountCore,
//		Region:      "us",
//		Shard:       -1,
