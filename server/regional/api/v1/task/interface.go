...
type Api interface {
	...
	SetRemainingTimeAndLogTime(shard int, accountId, projectId, taskId Id, timeRemaining uint64, myId Id, duration uint64, note *string) *timeLog //only applys to task tasks
