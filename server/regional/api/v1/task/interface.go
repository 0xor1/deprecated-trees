...
type Api interface {
	CreateNode(shard int, accountId, projectId, parentId, myId Id, previousSibling *Id, name, description string, isAbstract bool, isParallel *bool, memberId *Id, timeRemaining *uint64) *node
