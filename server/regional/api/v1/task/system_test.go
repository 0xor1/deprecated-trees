...
func Test_system(t *testing.T) {
	...
	nodeA := api.CreateNode(0, orgId, project.Id, project.Id, ali.Id, nil, "A", "ADesc", true, &falseVal, nil, nil)
	assert.Equal(t, true, nodeA.IsAbstract)
	assert.Equal(t, "A", nodeA.Name)
	assert.Equal(t, "ADesc", nodeA.Description)
	...
	api.CreateNode(0, orgId, project.Id, project.Id, ali.Id, &nodeA.Id, "B", "BDesc", true, &falseVal, nil, nil)
	nodeC := api.CreateNode(0, orgId, project.Id, project.Id, ali.Id, nil, "C", "CDesc", true, &trueVal, nil, nil)
	api.CreateNode(0, orgId, project.Id, project.Id, ali.Id, &nodeA.Id, "D", "DDesc", false, nil, &ali.Id, &fourVal)
	nodeE := api.CreateNode(0, orgId, project.Id, nodeC.Id, ali.Id, nil, "E", "EDesc", false, nil, &ali.Id, &twoVal)
	api.CreateNode(0, orgId, project.Id, nodeC.Id, ali.Id, &nodeE.Id, "F", "FDesc", false, nil, &ali.Id, &oneVal)
	api.CreateNode(0, orgId, project.Id, nodeC.Id, ali.Id, nil, "G", "GDesc", false, nil, &ali.Id, &fourVal)
	api.CreateNode(0, orgId, project.Id, nodeC.Id, ali.Id, &nodeE.Id, "H", "HDesc", false, nil, &ali.Id, &threeVal)
	nodeI := api.CreateNode(0, orgId, project.Id, nodeA.Id, ali.Id, nil, "I", "IDesc", false, nil, &ali.Id, &twoVal)
	api.CreateNode(0, orgId, project.Id, nodeA.Id, ali.Id, &nodeI.Id, "J", "JDesc", false, nil, &ali.Id, &oneVal)
	api.CreateNode(0, orgId, project.Id, nodeA.Id, ali.Id, nil, "K", "KDesc", false, nil, &ali.Id, &fourVal)
	nodeL := api.CreateNode(0, orgId, project.Id, nodeA.Id, ali.Id, &nodeI.Id, "L", "LDesc", true, &trueVal, nil, nil)
	api.CreateNode(0, orgId, project.Id, nodeL.Id, ali.Id, nil, "M", "MDesc", false, nil, &ali.Id, &threeVal)
