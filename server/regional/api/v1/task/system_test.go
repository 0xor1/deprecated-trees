...
func Test_system(t *testing.T) {
	...
	api.CreateTask(0, orgId, project.Id, taskC.Id, ali.Id, &taskE.Id, "F", &desc, false, nil, &ali.Id, &oneVal)
	taskG := api.CreateTask(0, orgId, project.Id, taskC.Id, ali.Id, nil, "G", &desc, false, nil, &ali.Id, &fourVal)
	api.CreateTask(0, orgId, project.Id, taskC.Id, ali.Id, &taskE.Id, "H", &desc, false, nil, &ali.Id, &threeVal)
