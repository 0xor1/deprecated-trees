...
func Test_system(t *testing.T) {
	...
	client.SetIsParallel(aliCss, 0, org.Id, proj.Id, &proj.Id, taskA.Id, true)
	client.SetIsParallel(aliCss, 0, org.Id, proj.Id, nil, proj.Id, false)
	client.SetMember(aliCss, 0, org.Id, proj.Id, taskL.Id, taskM.Id, &bob.Id)
	client.SetMember(aliCss, 0, org.Id, proj.Id, taskL.Id, taskM.Id, &cat.Id)
	client.SetMember(aliCss, 0, org.Id, proj.Id, taskL.Id, taskM.Id, nil)
	client.SetMember(aliCss, 0, org.Id, proj.Id, taskL.Id, taskM.Id, &cat.Id)
	client.SetRemainingTime(catCss, 0, org.Id, proj.Id, taskC.Id, taskG.Id, 1)
	note := "word up!"
	tl, err := client.SetRemainingTimeAndLogTime(catCss, 0, org.Id, proj.Id, taskC.Id, taskG.Id, 30, 40, &note)
