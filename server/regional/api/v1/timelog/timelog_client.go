...
type Client interface {
	...
	SetDuration(css *clientsession.Store, shard int, account, project, task, timeLog id.Id, duration uint64) error
	SetNote(css *clientsession.Store, shard int, account, project, task, timeLog id.Id, note *string) error
	Delete(css *clientsession.Store, shard int, account, project, task, timeLog id.Id) error
	Get(css *clientsession.Store, shard int, account, project id.Id, task, member, timeLog, after *id.Id, limit int) ([]*tlog.TimeLog, error)
}
...
func (c *client) SetDuration(css *clientsession.Store, shard int, account, project, task, timeLog id.Id, duration uint64) error {
...
func (c *client) SetNote(css *clientsession.Store, shard int, account, project, task, timeLog id.Id, note *string) error {
...
func (c *client) Delete(css *clientsession.Store, shard int, account, project, task, timeLog id.Id) error {
...
func (c *client) Get(css *clientsession.Store, shard int, account, project id.Id, task, member, timeLog, after *id.Id, limit int) ([]*tlog.TimeLog, error) {
