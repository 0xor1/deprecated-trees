...
func GetProjectExists(ctx *core.Ctx, shard int, accountId, projectId id.Id) bool {
...
func GetAccountRole(ctx *core.Ctx, shard int, accountId, memberId id.Id) *cnst.AccountRole {
...
func GetProjectRole(ctx *core.Ctx, shard int, accountId, projectId, memberId id.Id) *cnst.ProjectRole {
...
func GetAccountAndProjectRoles(ctx *core.Ctx, shard int, accountId, projectId, memberId id.Id) (*cnst.AccountRole, *cnst.ProjectRole) {
...
func GetAccountAndProjectRolesAndProjectIsPublic(ctx *core.Ctx, shard int, accountId, projectId, memberId id.Id) (*cnst.AccountRole, *cnst.ProjectRole, *bool) {
...
func GetPublicProjectsEnabled(ctx *core.Ctx, shard int, accountId id.Id) bool {
...
func MakeChangeHelper(ctx *core.Ctx, shard int, sql string, args ...interface{}) {
...
func TreeChangeHelper(ctx *core.Ctx, shard int, sql string, args ...interface{}) {
